...
function checking(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var filename, height, width, format, error, fileLoc, img, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileLoc = path_1.default.resolve(__dirname + "../../../images/full/" + filename + ".jpeg");
                    if (!!(0, fileExists_1.fileExists)(fileLoc)) return [3 /*break*/, 1];
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, processing_1.default)(filename, width, height, format)];
                case 3:
                    img = _a.sent();
                    res.end(img, "binary");
                    return [3 /*break*/, 5];
